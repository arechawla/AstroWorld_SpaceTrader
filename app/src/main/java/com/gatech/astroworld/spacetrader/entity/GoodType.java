...
public enum GoodType {
    WATER("Water", 5, 0, 0, 0, 2, 30, 3, 4, LOTSOFWATER, 30, 50),
    FURS("Furs", 6, 0, 0, 0, 0, 250, 10, 10, RICHFAUNA, 230, 280),
    ORE("Ore", 7, 0, 2, 2, 3, 350, 20, 10, MINERALRICH, 350, 420),
    FOOD("Food", 5, 0, 1, 0, 1, 100, 5, 5, RICHSOIL, 90, 160),
    GAMES("Games", 5, 0, 3, 1, 6, 250, -10, 5, ARTISTIC, 160, 270),
    FIREARMS("Firearms", 5, 0, 3, 1, 5, 1250, -75, 100, WARLIKE, 600, 1100),
    MEDICINE("Medicine", 5, 0, 4, 1, 6, 650, -20, 10, LOTSOFHERBS, 400, 700),
    NARCOTICS("Narcotics", 5, 0, 5, 0, 5, 3500, -125, 150, WEIRDMUSHROOMS, 2000, 3000),
    ROBOTS("Robots", 5, 0, 6, 4, 7, 5000, -150, 100, null, 3500, 5000);
